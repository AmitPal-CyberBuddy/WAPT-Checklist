import { PRESET_LIST } from '../data/presets.mjs?v=1.0.0-r3';
import { deriveUrlHints, normalizeScopeAnswers } from '../engine/context.js?v=1.0.0-r3';
...
export function applicableQuestions(answers = {}) {
  ...
  if (!runtimeRelevant) ['backend', 'database'].forEach((key) => hidden.add(key));
