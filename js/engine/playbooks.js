...
import { contextHas, deriveContext } from './context.js?v=1.0.0-r17';
import { APPLICABILITY, evaluateApplicability, evaluateConditionMap } from './applicability.js?v=1.0.0-r17';
