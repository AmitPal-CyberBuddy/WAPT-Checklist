...
- **Page playbooks:** sixteen surface packs that expand to **every applicable check** for the page in front of you (static ≈ 180, login ≈ 300), each with named variants and copyable payloads — not a shortlist of methodology titles. Scoping a static site opens that playbook; every other scope lands on the matching board.
